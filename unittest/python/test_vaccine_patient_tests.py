...
class TestVaccinePatient(TestCase):
    ...
    def test_vaccine_patient_ok(self):
        ...
        my_manager = VaccineManager()
        value = my_manager.vaccine_patient("5a06c7bede3d584e934e2f5bd3861e625cb31937f9f1a5362a51fbbf38486f1c")# noqa
        self.assertTrue(value)
        vaccination_log = VaccinationJsonStore()
        vaccination_entry = vaccination_log.find_item("5a06c7bede3d584e934e2f5bd3861e625cb31937f9f1a5362a51fbbf38486f1c")# noqa
